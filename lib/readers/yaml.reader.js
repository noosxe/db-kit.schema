...
YamlReader.prototype.normalizeDoc = function(doc) {
	...
	_.forEach(doc.connections, function(connection, name) {
		...
		connection.parent.options.links = connection.parent.options.links || {};
		connection.child.options.links = connection.child.options.links || {};

		connection.parent.options.links[connection.child.options.collectionName] = connection;
		connection.child.options.links[connection.parent.options.collectionName] = connection;
	});
